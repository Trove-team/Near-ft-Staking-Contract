...
import {
  TELOS_TESTNET_JUMP_TOKEN,
  TELOS_TESTNET_XJUMP_TOKEN,
} from "@/env/contract";
...
export default function CoinStakingHome() {
  ...
  const { data: StakedJump } = useContractRead({
    address: TELOS_TESTNET_XJUMP_TOKEN,
    abi: xTokenAbi.abi,
  ...
  function renderChartDetailBox(name: string, value: string) {
    return (
      <div className="flex flex-col rounded-[20px] bg-white-600 p-4  sm:h-[80px] gap-y-4 w-auto md:w-[38.1%] lg:w-[42.1%]">
  ...
  function renderChart(selectedData) {
    return (
      <div className="rounded-lg bg-white-600 p-6 flex flex-col">
        ...
        >
          <div className="flex flex-row gap-x-6  flex-1">
          ...
          <Tab.Panels>
            <Tab.Panel className="outline-none">
              <MantleXTokenStakePanel
                ...
                tokenAddress={TELOS_TESTNET_JUMP_TOKEN}
                XtokenAddress={TELOS_TESTNET_XJUMP_TOKEN}
                RPC_URL="https://testnet.telos.net/evm"
              />
            </Tab.Panel>
            <Tab.Panel className="outline-none">
