...
import {
  TELOS_MAINNET_JUMP_TOKEN,
  TELOS_MAINNET_XJUMP_TOKEN,
} from "@/env/contract";
...
export default function CoinStakingHome() {
  ...
  const { data: StakedJump } = useContractRead({
    address: TELOS_MAINNET_XJUMP_TOKEN,
    abi: xTokenAbi.abi,
          ...
          <Tab.Panels>
            <Tab.Panel className="outline-none">
              <MantleXTokenStakePanel
                ...
                tokenAddress={TELOS_MAINNET_JUMP_TOKEN}
                XtokenAddress={TELOS_MAINNET_XJUMP_TOKEN}
